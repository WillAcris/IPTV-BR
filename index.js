...
const CATEGORIES = [
  ...
  { id: 'cat_reality', name: 'Reality Shows', keywords: ['reality', 'masterchef', 'shark tank', 'canais | reality', 'estrela da casa', 'mtv com o ex', 'Estrela da Casa 1', 'Estrela da Casa 2', 'Mosaico'] },
  ...
  { id: 'cat_internacional', name: 'Internacional', keywords: ['internacional', 'sic', 'rtp', 'tvi', 'cnn international', 'canais | internacional', 'eleven sports', 'canal 11', 'tv5 monde', 'fox news now', 'sony canal comedias', 'deportes', 'wwe youtube', 'europe', 'usa', 'uk', 'spain', 'portugal', 'france', 'italy', 'germany', 'argentina', 'chile', 'mexico', 'colombia', 'venezuela', 'uruguay', 'peru', 'ecuador'] },
  { id: 'cat_pluto', name: 'Pluto TV', keywords: ['pluto', 'pluto tv', 'Pluto TV Canal UOL', 'pluto tv investigação', 'pluto tv junior', 'pluto tv netmovies', 'pluto tv bang bang', 'pluto tv filmes aventura', 'pluto tv terror trash', 'pluto tv cine crime', 'pluto tv cine inspiração', 'pluto tv cine sucessos', 'pluto tv filmes ação', 'pluto tv cine terror', 'pluto tv cine drama', 'pluto tv cine família', 'pluto tv cine romance', 'pluto tv cine comédia romântica', 'pluto tv cine comédia', 'pluto tv cine clássicos', 'pluto tv filmes nacionais', 'pluto tv ficção científica', 'pluto tv adrenalina freezone', 'pluto tv kids', 'pluto tv desenhos clássicos', 'pluto tv kids club', 'pluto tv cineminha'] },
  { 
    id: 'cat_aberto', 
    name: 'Canais Abertos', 
    keywords: [
      ...
      // TVs regionais
      'tv são luís', 'imperial tv', 'rtn tv', 'tv ceará', 'tv diário', 'tve bahia', 'tve bahia hd', 'TVE Bahia HD', 'TVE', 'tve rs', 'tv brasil es', 
