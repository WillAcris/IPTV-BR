    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      if (line.startsWith('#EXTINF:')) {
        ...
        if (url && name && name.length > 0) {
          ...
          if (hasValidProtocol) {
            // =======================================================================
            // ALTERAÇÃO 1: Simplificação do filtro de URL
            // A antiga verificação "isLikelyStream" era muito restritiva.
            // Agora, apenas verificamos se a URL começa com um protocolo válido
            // e a adicionamos, permitindo que todos os canais passem.
            // =======================================================================
            items.push({
  ...
  try {
    ...
    const metas = items
      ...
      .map(ch => ({
        ...
        genres: ['IPTV'],
        releaseInfo: 'Ao Vivo'
      })); // <-- ALTERAÇÃO 2: .slice(0, 100) foi REMOVIDO daqui
